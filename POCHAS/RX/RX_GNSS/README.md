...
* **Bluetooth:** Headphones must be connected to the RPi via Bluetooth (you must connect them after running `install.sh`).
...
# 4. Navigate to the receiver (GNSS) directory
